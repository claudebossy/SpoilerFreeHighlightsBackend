...
WSGI_APPLICATION = 'spoiler_free_highlights.wsgi.application'
...
PROJECT_DIRNAME = 'spoiler_free_highlights'
...
TEMPLATES = [{
    ...
    'DIRS': [
        os.path.join(BASE_DIR, 'spoiler_free_highlights', 'templates'),
    ],
    'OPTIONS': {
        'context_processors': [
...
INSTALLED_APPS = (
    ...
    'apps.external_api.apps.NBAConfig',
